...
from bluefox3d import models, datasets, trainers
from bluefox3d.utils.dist_utils import setup_dist
...
if __name__ == '__main__':
    ...
    parser.add_argument('--wandb_project', type=str, default='bluefox3d-training', help='Wandb project name')
