...
class BlueFox3DMVImageTo3DPipeline(BlueFox3DImageTo3DPipeline):
    """
    Multi-view variant of the BlueFox3D proj pipeline.
    ...
    def _views_of(self, image) -> dict:
        ...
        if not isinstance(views, dict) or 'images' not in views:
            raise TypeError(
                "BlueFox3DMVImageTo3DPipeline expects a views dict (see run_mv), "
...
Pixal3DMVImageTo3DPipeline = BlueFox3DMVImageTo3DPipeline
