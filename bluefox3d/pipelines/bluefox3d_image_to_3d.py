...
class BlueFox3DImageTo3DPipeline(Pipeline):
    """
    Pipeline for inferring BlueFox3D (proj mode) image-to-3D models.
    ...
    @classmethod
    def from_pretrained(cls, path: str, config_file: str = "pipeline.json") -> "BlueFox3DImageTo3DPipeline":
        """
    ...
    def run(
        ...
        """
        Run the BlueFox3D pipeline (proj mode, cascade).
        ...
        if pipeline_type == '1024_cascade':
            ...
            raise ValueError(f"Invalid pipeline type for BlueFox3D proj mode: {pipeline_type}. "
...
# Legacy name used by the public checkpoint pipeline.json
Pixal3DImageTo3DPipeline = BlueFox3DImageTo3DPipeline
